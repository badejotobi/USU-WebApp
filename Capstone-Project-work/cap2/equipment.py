...
initial_data = [
    ...
    {'id': 4,'name': 'Call of Duty Ghosts', 'console': 'Xbox', 'available': True},
    ...
    {'id': 16,'name': 'Injustice 2', 'console': 'Xbox', 'available': True},
    ...
    {'id': 22,'name': 'NBA 2K22', 'console': 'Xbox', 'available': True},
    ...
    {'id': 26,'name': 'Tom Clancy\'s Rainbow 6 Siege', 'console': 'Xbox', 'available': True} ]
'''
    # PlayStation
    ...
    {'name': 'The Last of Us Remastered', 'console': 'PlayStation', 'available': True},
